...
export const enrichmentData: Record<string, EnrichedDiseaseEntry> = {
  ...
  K07: {
    ...
    pathophysiology:
      'K07의 기전은 하위 유형마다 다르지만, 공통적으로는 턱 성장 불균형, 치아 배열 이상, 기능 습관, 턱관절 및 저작근의 기능장애가 교합과 얼굴 비대칭, 저작 불편으로 이어질 수 있습니다.',
    etiology: [
      '유전적 턱 성장 패턴과 얼굴 골격 차이',
      '치아 과밀·공간 부족·조기 상실·맹출 이상',
      '손가락 빨기, 혀 내밀기, 구호흡 같은 기능 습관',
      '이갈이, 턱관절 주변 근육·관절의 기능 문제',
    ],
    risk_factors: ['가족력', '성장기 악습관', '맹출 이상과 과밀', '턱관절 통증 또는 이갈이'],
    anatomy_involved: ['상악', '하악', '치열궁', '턱관절(TMJ)', '저작근'],
    symptoms: [
      {
        name: '치아가 고르지 않거나 물림이 맞지 않아 씹기 불편하고, 얼굴 비대칭이나 입 벌림 습관이 동반될 수 있습니다.',
        severity: 'mild',
        is_pathognomonic: false,
      },
      {
        name: '턱이 아프거나 소리가 나고, 입이 잘 안 벌어지거나 교합이 갑자기 달라진 느낌이 들 수 있습니다.',
        severity: 'moderate',
        is_pathognomonic: false,
      },
    ],
    diagnostic_criteria: [
      '치아 배열, 교합 관계, 얼굴 정중선과 턱 위치를 진찰합니다.',
      '치과 X-ray, 두부 방사선 분석, 치열 모델이 필요할 수 있습니다.',
      '턱 통증이나 소리가 있으면 TMJ와 저작근의 기능 평가를 따로 진행합니다.',
    ],
    treatment: [
      {
        approach: '교정 치료와 성장기 습관 교정',
        description:
          '치열과 교합 이상은 브라켓·투명교정·유지장치 같은 교정 치료와, 손가락 빨기·구호흡 같은 기능 습관 교정이 중심이 됩니다.',
        evidence_level: 'Expert',
        is_insured: null,
      },
      {
        approach: '보존적 턱관절 관리와 필요시 수술',
        description:
          '턱관절 증상은 자가관리, 스플린트, 물리치료, 통증 조절이 우선이고, 심한 골격성 불균형은 교정과 함께 악교정수술을 고려할 수 있습니다.',
        evidence_level: 'Expert',
        is_insured: null,
      },
    ],
    complications: ['청결 어려움과 충치 위험 증가', '치아 마모', '저작·발음 불편', '턱 통증과 기능 제한'],
    prognosis:
      '성장기와 조기 개입 시 교정 효율이 좋지만, 성인에서도 충분히 개선 가능합니다. 다만 하위 유형마다 치료 기간과 방식은 크게 다릅니다.',
    prevention: [
      '손가락 빨기, 혀 내밀기, 구호흡 같은 습관은 일찍 교정하는 것이 좋습니다.',
      '성장기 검진에서 턱 크기 차이나 과밀을 조기 확인하면 치료 범위를 줄일 수 있습니다.',
      '턱 통증과 잡음은 무조건 참고 버티지 말고 원인을 확인합니다.',
    ],
    patient_friendly_summary:
  ...
  K10: {
    ...
    pathophysiology:
      '하위 질환에 따라 턱뼈 발달 이상, 발치 후 혈병 소실과 염증, 감염성 뼈 병변, 혈류 저하에 따른 골괴사처럼 기전이 다릅니다. 공통적으로는 턱뼈와 주변 연조직의 통증·부종·기능 저하를 만들 수 있습니다.',
    etiology: [
      '발치 후 치유 장애나 치조염',
      '약물 관련 또는 혈류 저하와 연관된 턱뼈괴사',
      '턱뼈 발육 이상과 구조적 결함',
      '감염·염증 또는 외상 후 턱뼈 병변',
    ],
    ...
    treatment: [
      {
        approach: '원인별 보존 치료와 통증 조절',
        description:
          '치조염이나 경한 염증성 문제는 세척, 진통, 구강위생 관리, 식이 조절 같은 보존 치료가 중심이 될 수 있습니다.',
        evidence_level: 'Expert',
        is_insured: null,
      },
      {
        approach: '전문과 평가와 시술',
        description:
          '턱뼈괴사나 구조 이상은 약물 조정, 항생제, 제한적 변연절제, 추가 수술처럼 하위 질환에 맞는 전문 치료가 필요할 수 있습니다.',
        evidence_level: 'Expert',
        is_insured: null,
      },
    ],
    complications: ['만성 턱 통증', '치유 지연', '씹기 기능 저하', '반복 감염 또는 노출골'],
    prognosis:
      '예후는 하위 질환에 따라 크게 다르지만, 발치 후 이상 통증이나 비정상적 턱 증상을 빨리 평가할수록 합병증을 줄이기 쉽습니다.',
    prevention: [
      '발치 후 주의사항을 잘 지키고, 심한 통증이나 치유 지연이 있으면 빨리 진료를 받습니다.',
      '턱뼈괴사 위험 약물을 쓰는 경우 치과 치료 전 약물·질환 정보를 공유합니다.',
      '외상과 감염을 방치하지 않고 조기 치료합니다.',
    ],
    patient_friendly_summary:
